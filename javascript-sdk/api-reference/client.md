...
The initially loaded device. It updates when the device changes. See [DeviceInfo](types/deviceinfo.md).

### app

The initially loaded app. It updates when the app changes. See [AppetizeApp](types/appetizeapp.md).
